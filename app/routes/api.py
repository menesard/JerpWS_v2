...
def add_item():
    ...
    try:
        ...
        if region == 'safe':
            result = SystemManager.add_item_safe(setting, gram)
        else:
            result = SystemManager.add_item(region, setting, gram)
...
def remove_item():
    ...
    try:
        ...
        if region == 'safe':
            result = SystemManager.remove_item_safe(setting, gram)
        else:
            result = SystemManager.remove_item(region, setting, gram)
