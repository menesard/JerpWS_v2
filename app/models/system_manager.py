from app import db
from app.models.database import Region, Setting, Operation, Customer, CustomerTransaction
...
class SystemManager:
    ...
    @staticmethod
    def add_item_safe(setting_name, gram):
        """Kasaya altın ekle"""
    ...
    @staticmethod
    def remove_item_safe(setting_name, gram):
        """Kasadan altın çıkar"""
        setting_id = SystemManager.get_setting_id(setting_name)
        safe_id = SystemManager.get_region_id('safe')
    ...
    @staticmethod
    def add_item(region_name, setting_name, gram):
    ...
    @staticmethod
    def remove_item(region_name, setting_name, gram):
    ...
    def add_customer_transaction(customer_id, transaction_type, setting_name, gram,
                                 ...
                                 purity_per_thousand=None, labor_percentage=0, notes=None):
        ...
        if transaction_type in [TRANSACTION_PRODUCT_OUT, TRANSACTION_SCRAP_OUT]:
            SystemManager.remove_item_safe(setting_name, gram)
        ...
        # Ürün girişi veya hurda girişi için kasa stokunu güncelle
            ...
            SystemManager.add_item_safe(setting_name, gram)
